...
{
    // For now, use tank images as placeholders for armored car images
    // In the future, specific armored car images should be added to the resources
    ...
    if (tankSize.isValid() && tankSize.canConvert<QSizeF>()) {
        m_armoredCarIconSize = tankSize.toSizeF();
    } else {
